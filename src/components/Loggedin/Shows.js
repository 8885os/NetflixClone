...
const Shows = ({ show }) => {
    ...
    return (
        <div className='movie-show-div'>
            ...
            {Object.keys(viewShow).length > 0 ? <div className='movie-show'>
                <div className='season-position'>
                    ...
                    <FormControl className='form-select' sx={{
                        m: 1, minWidth: 120, color: 'white', borderColor: 'white', borderBlockColor: 'white', borderBlockEndColor: 'white', borderBlockStartColor: 'white',
                ...
                <div className='movie-show-desc-holder'>
                    ...
                    <div className='avatar-holder'>
                        {viewShow['created_by'].map(item =>
                            ...
                            <>
                                <Avatar sx={{ height: '70px', width: '70px' }} src={baseurl + item['profile_path']}></Avatar>
                                <h4 className='movie-show-desc'>{item['name']}</h4>
                            </>
                        )}
                    </div>
                </div>
                <div className='season-holder'></div>
